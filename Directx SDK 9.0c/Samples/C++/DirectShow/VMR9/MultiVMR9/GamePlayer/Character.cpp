...
const TCHAR g_achMeshFile[] = TEXT("Tiny\\tiny.x");
const TCHAR g_achSkinFile[] = TEXT("Tiny\\Tiny_skin.bmp");
        ...
        if (NumMaterials > 0)            
        {
            ...
            for (iMaterial = 0; iMaterial < NumMaterials; iMaterial++)
            {
                if (pMeshContainer->pMaterials[iMaterial].pTextureFilename != NULL)
                {
                    ...
                    _tcsncpy( strTextureFileName, TEXT("Tiny\\"), MAX_PATH );
                    _tcsncat( strTextureFileName, pMeshContainer->pMaterials[iMaterial].pTextureFilename, MAX_PATH );
