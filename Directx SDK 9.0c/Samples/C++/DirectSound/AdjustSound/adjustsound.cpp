...
VOID ValidateWaveFile( HWND hDlg, TCHAR* strFileName )
{
    ...
    else // The load call succeeded
    {
        ...
        wcscpy( m_strWaveFileName, strFileName );
...
VOID UpdateBehaviorText( HWND hDlg )
{
    ...
    if( bFocusSticky )
    {
        wcscpy( strExcepted, L"Buffers with \"sticky\" focus will continue to play "
    ...
    {
        wcscpy( strExcepted, L"Buffers with global focus will continue to play if the user "
    ...
    {
        // Normal focus
        wcscpy( strExcepted, L"Buffers with normal focus will mute if the user switches "
