...
*/
                    ...
                    GetGlobalOptions().dwNumChannels = (IsDlgButtonChecked( hDlg, IDC_SPECTRAL_CHECK ) == BST_CHECKED ) * 3;
...
void CPRTOptionsDlg::UpdateControlsWithSettings( HWND hDlg )
{
    ...
    _snwprintf( sz, 256, TEXT("%0.2f"), GetGlobalOptions().Absoption.r ); sz[255] = 0; SetDlgItemText( hDlg, IDC_ABSORPTION_R_EDIT, sz ); 
    _snwprintf( sz, 256, TEXT("%0.2f"), GetGlobalOptions().Absoption.g ); sz[255] = 0; SetDlgItemText( hDlg, IDC_ABSORPTION_G_EDIT, sz ); 
    _snwprintf( sz, 256, TEXT("%0.2f"), GetGlobalOptions().Absoption.b ); sz[255] = 0; SetDlgItemText( hDlg, IDC_ABSORPTION_B_EDIT, sz ); 
