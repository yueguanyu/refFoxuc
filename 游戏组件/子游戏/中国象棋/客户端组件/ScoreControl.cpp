...
CScoreControl::CScoreControl()
{
	...
	m_ImageWinLose.LoadFromResource(hResInstance,IDB_WIN_LOSE);
...
VOID CScoreControl::OnPaint()
{
	...
	//绘画背景
	m_ImageGameScore.TransDrawImage(&DCBuffer,0,0,RGB(255,0,255));
	...
	//if(m_GameScoreInfo.cbReason!=REASON_TEN_STEP)
	{
		...
		for (BYTE i=0;i<GAME_PLAYER;i++)
		{
			...
			m_ImageWinLose.TransDrawImage(&DCBuffer,22,138+i*52,nImageWidht,nImageHeight,nImageExcursion,0,RGB(255,0,255));
		}
	}
