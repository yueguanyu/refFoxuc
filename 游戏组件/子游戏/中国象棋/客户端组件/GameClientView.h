...
protected:
	...
	CBitImageEx						m_ImageClockNumber;					//数字资源
	CBitImageEx						m_ImageControlBack;					//控制背景
	CBitImageEx						m_ImageUserInfoFlag;				//用户标志
	CBitImageEx						m_ImageUserInfoView;				//用户信息
	CBitImageEx						m_ImageChessManualT;				//棋谱背景
	CBitImageEx						m_ImageChessManualM;				//棋谱背景
	CBitImageEx						m_ImageChessManualB;				//棋谱背景
...
protected:
	...
	//用户等级
	TCHAR *GetLevelDescribe(LONGLONG lUserScore,TCHAR tcUserInfo[32]);
