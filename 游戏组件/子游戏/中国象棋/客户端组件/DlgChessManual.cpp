...
CDlgChessManual::CDlgChessManual() : CDialog(IDD_CHESS_MANUAL)
{
	...
	//加载资源
	m_ImageViewBack.LoadFromResource(AfxGetInstanceHandle(),IDB_MANUAL_VIEW_BACK);
...
BOOL CDlgChessManual::OnInitDialog()
{
	...
	m_btHide.SetButtonImage(IDB_MANUAL_VIEW_BT_HIDE,hResInstance,false,false);
	m_btCancel.SetButtonImage(IDB_MANUAL_VIEW_BT_CLOSE,hResInstance,false,false);
	m_btManualLoad.SetButtonImage(IDB_MANUAL_VIEW_BT_LOAD,hResInstance,false,false);
	m_btManualSave.SetButtonImage(IDB_MANUAL_VIEW_BT_SAVE,hResInstance,false,false);
	m_btManualNote.SetButtonImage(IDB_MANUAL_VIEW_BT_NOTE,hResInstance,false,false);
	m_btManualHead.SetButtonImage(IDB_MANUAL_VIEW_BT_HEAD,hResInstance,false,false);
	m_btManualLast.SetButtonImage(IDB_MANUAL_VIEW_BT_LAST,hResInstance,false,false);
	m_btManualPlay.SetButtonImage(IDB_MANUAL_VIEW_BT_PLAY,hResInstance,false,false);
	m_btManualNext.SetButtonImage(IDB_MANUAL_VIEW_BT_NEXT,hResInstance,false,false);
	m_btManualTail.SetButtonImage(IDB_MANUAL_VIEW_BT_TAIL,hResInstance,false,false);
