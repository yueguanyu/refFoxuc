...
CGameServiceManager::CGameServiceManager(void)
{
	...
	lstrcpyn(m_GameServiceAttrib.szClientEXEName,TEXT("ChinaChess.exe"),CountArray(m_GameServiceAttrib.szClientEXEName));
	lstrcpyn(m_GameServiceAttrib.szServerDLLName,TEXT("ChinaChessServer.dll"),CountArray(m_GameServiceAttrib.szServerDLLName));
...
bool CGameServiceManager::RectifyParameter(tagGameServiceOption & GameServiceOption)
{
	...
	{
		GameServiceOption.lMinTableScore=__max(GameServiceOption.lMinTableScore*50L,GameServiceOption.lMinTableScore);
	}
