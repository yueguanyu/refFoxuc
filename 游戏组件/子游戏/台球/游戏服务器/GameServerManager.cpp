...
CGameServiceManager::CGameServiceManager(void)
{
	...
	lstrcpyn(m_GameServiceAttrib.szClientEXEName,TEXT("TaiQiu.exe"),CountArray(m_GameServiceAttrib.szClientEXEName));
	lstrcpyn(m_GameServiceAttrib.szServerDLLName,TEXT("TaiQiuServer.dll"),CountArray(m_GameServiceAttrib.szServerDLLName));
	return;
}
