...
void CScoreView::OnPaint() 
{
	...
	CFont font,*OldFont;
	font.CreateFont(13,0,0,0,500,0,0,0,134,3,2,1,2,TEXT("宋体"));
	...
	for (WORD i=0;i<CountArray(m_szUserName);i++)
	{
		if (m_szUserName[i][0]!=0)
		{
			...
			_i64tot(m_lScore[i],szBuffer,10);
			...
			m_ImageWinLose.BlendDrawImage(&dc,182+(253-182)/2-nWinLoseWidth/2,wStation*29+79+29/2-nWinLostHeight/2,nWinLoseWidth,nWinLostHeight,
				byIndex*nWinLoseWidth,0,RGB(255,0,255),255);

			//服务费用
			CRect rcService(253,wStation*29+79,321,(wStation+1)*29+79);
			_i64tot(m_lGameTax[i],szBuffer,10);
