	...
	for (WORD i=0;i<m_wCardCount;i++)
	{
		...
		}else
		{
				...
				if(1==i)
				{
					...
					m_ImageOpenCardHandle.TransDrawImage(pDC,OriginPoint.x-5,OriginPoint.y+nYDrawPos-5,m_ImageOpenCardHandle.GetWidth(),m_ImageOpenCardHandle.GetHeight(),0,0,RGB(255,0,255));
