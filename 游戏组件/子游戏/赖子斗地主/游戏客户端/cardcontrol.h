...
protected:
	...
	static CPngImage				m_ImageLaiZi;						//赖子标识

	//选择变量
protected:
	DWORD							m_wEndIndex;						//结束索引
	DWORD							m_wStartIndex;						//开始索引
	BYTE							m_bLaiZiValue;						//赖子值
...
public:
	...
	//设置扑克
	DWORD SetNoChangeCard(const BYTE bCardData[], DWORD dwCardCount);
	//获取扑克
	...
	//设置赖子
	void SetLaiZivalue(BYTE bLaiZiValue){m_bLaiZiValue=bLaiZiValue;};
