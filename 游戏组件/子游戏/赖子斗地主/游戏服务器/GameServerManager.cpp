...
CGameServiceManager::CGameServiceManager(void)
{
	...
	lstrcpyn(m_GameServiceAttrib.szClientEXEName,TEXT("LandCrazyEx.EXE"),CountArray(m_GameServiceAttrib.szClientEXEName));
	lstrcpyn(m_GameServiceAttrib.szServerDLLName,TEXT("LandCrazyExServer.DLL"),CountArray(m_GameServiceAttrib.szServerDLLName));


#ifdef VIDEO_GAME
	lstrcpyn(m_GameServiceAttrib.szDataBaseName,TEXT( "QPTreasureDB" ),CountArray(m_GameServiceAttrib.szDataBaseName));	
	lstrcpyn(m_GameServiceAttrib.szClientEXEName,TEXT("LandCrazyExVD.EXE"),CountArray(m_GameServiceAttrib.szClientEXEName));
	lstrcpyn(m_GameServiceAttrib.szServerDLLName,TEXT("LandCrazyExVDServer.DLL"),CountArray(m_GameServiceAttrib.szServerDLLName));
#endif
...
bool  CGameServiceManager::RectifyParameter(tagGameServiceOption & GameServiceOption)
{
	...
	{
		GameServiceOption.lMinTableScore=__max(GameServiceOption.lCellScore*96L,GameServiceOption.lMinTableScore);
	}
