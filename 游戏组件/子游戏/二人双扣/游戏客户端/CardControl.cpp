...
VOID CCardControl::DrawCardControl(CDC * pDC)
{
	...
	//{
	//	m_ImageCardSelect.LoadImage(AfxGetInstanceHandle(),TEXT("CARD_SELECT"));
	//}
	...
	for (WORD i=0;i<m_wCardCount;i++)
	{
		...
		if ((m_wStartIndex<=i)&&(i<=m_wEndIndex))
		{
			...
			m_ImageCardSelect.DrawImage(pDC,OriginPoint.x+nXDrawPos,OriginPoint.y+nYDrawPos,SizeSelectImage.cx,SizeSelectImage.cy,0,0);
		}
	}
