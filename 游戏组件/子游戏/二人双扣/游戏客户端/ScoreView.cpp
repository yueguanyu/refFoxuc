...
CScoreView::CScoreView(void)
{
	...
	m_ImageWinLose.LoadFromResource(AfxGetInstanceHandle(),IDB_WINLOSE);
}
...
void CScoreView::OnPaint() 
{
	...
	for (WORD i=0;i<CountArray(m_szUserName);i++)
	{
		...
		m_ImageWinLose.TransDrawImage(&dc,242-nWinLoseWidth/3,i*29+90-nWinLostHeight/3,nWinLoseWidth,nWinLostHeight,
