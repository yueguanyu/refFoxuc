...
BEGIN_MESSAGE_MAP(CDlgRequestLeave, CSkinDialog)
END_MESSAGE_MAP()

//////////////////////////////////////////////////////////////////////////

//构造函数
CDlgRequestLeave::CDlgRequestLeave() : CSkinDialog(IDD_REQUEST_LEAVE)
{
	//设置变量
...
VOID CDlgRequestLeave::OnOK()
{
	...
	ASSERT(m_pGameFrameDlg!=NULL);
	{
		...
		if (pGameFrameEngine!=NULL) pGameFrameEngine->PostMessage(IDM_REQUEST_LEAVE,(WPARAM)szLeaveReason,0);
	}
