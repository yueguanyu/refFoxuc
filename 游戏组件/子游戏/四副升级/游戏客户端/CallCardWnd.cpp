	...
	case IDC_CALL_NT:			//无主
		{
			...
			if (pGameFrameEngine!=NULL) pGameFrameEngine->PostMessage(IDM_CALL_CARD,COLOR_NT,COLOR_NT);
	...
	case IDC_CALL_HEI_TAO:		//黑桃
		{
			...
			CGameFrameEngine * pGameFrameEngine=CGameFrameEngine::GetInstance();
			if (pGameFrameEngine!=NULL) pGameFrameEngine->PostMessage(IDM_CALL_CARD,COLOR_HEI_TAO,COLOR_HEI_TAO);
	...
	case IDC_CALL_HONG_TAO:		//红桃
		{
			...
			CGameFrameEngine * pGameFrameEngine=CGameFrameEngine::GetInstance();
			if (pGameFrameEngine!=NULL) pGameFrameEngine->PostMessage(IDM_CALL_CARD,COLOR_HONG_TAO,COLOR_HONG_TAO);
			return TRUE;
		}
	case IDC_CALL_MEI_HUA:		//梅花
		{
			...
			CGameFrameEngine * pGameFrameEngine=CGameFrameEngine::GetInstance();
			if (pGameFrameEngine!=NULL) pGameFrameEngine->PostMessage(IDM_CALL_CARD,COLOR_MEI_HUA,COLOR_MEI_HUA);
			return TRUE;
		}
	case IDC_CALL_FANG_KUAI:	//方块
		{
			...
			CGameFrameEngine * pGameFrameEngine=CGameFrameEngine::GetInstance();
			if (pGameFrameEngine!=NULL) pGameFrameEngine->PostMessage(IDM_CALL_CARD,COLOR_FANG_KUAI,COLOR_FANG_KUAI);
