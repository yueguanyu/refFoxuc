...
protected:
	...
	BYTE							m_cbScoreCardData[PACK_COUNT*12];	//扑克数据
...
protected:
	...
	CBitImage						m_ImageCenter;						//居中背景
	CBitImage						m_ImageBanker;						//庄家资源
	CBitImage						m_ImageLastTurn;					//上轮标志
	CBitImage						m_ImageColorFlag;					//花色标志
	CBitImage						m_ImageWaitConceal;					//等待资源
	CBitImage						m_ImageStatusInfo;					//得分状态
	CBitImage						m_ImageScoreCard;					//得分牌
