...
#define CHR_KING_WAIT				0x0008								//精掉权位
...
public:
	...
	//吃胡分析
	WORD AnalyseChiHuCard(BYTE cbCardIndex[MAX_INDEX], tagWeaveItem WeaveItem[], BYTE cbWeaveCount, BYTE cbCurrentCard, WORD wChiHuRight, tagChiHuResult & ChiHuResult,bool bZimo=true);
...
private:
	...
	//7星
	bool ServenStar(BYTE cbCardIndex[MAX_INDEX]);
	//七小对牌
	bool IsQiXiaoDui(const BYTE cbCardIndex[MAX_INDEX], const tagWeaveItem WeaveItem[], const BYTE cbWeaveCount,const BYTE cbCurrentCard,BYTE cbGerman);
	//3顺 3刻
	bool IsNeat3(BYTE cbCardIndex[MAX_INDEX],BYTE &cbGerman);
	// 对子 豪华对子
