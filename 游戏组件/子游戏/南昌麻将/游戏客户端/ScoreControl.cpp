...
void CScoreControl::OnPaint()
{
	...
	for (WORD i=0;i<GAME_PLAYER;i++)
	{
		...
		//牌型信息
		CString strCardInfo;
		LPCTSTR pszCardKind[]={TEXT("碰碰胡"),TEXT("七小对"),TEXT("十三幺"),TEXT("七星"),TEXT("德国七对")};
		LPCTSTR pszCardRight[]={TEXT("地胡"),TEXT("天胡"),TEXT("抢杠胡"),TEXT("杠开胡"),TEXT("精掉"),TEXT("德国"),TEXT("德中德"),TEXT("自摸")};
