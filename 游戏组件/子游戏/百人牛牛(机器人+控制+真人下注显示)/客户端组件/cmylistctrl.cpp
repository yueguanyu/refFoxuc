...
void CHeaderCtrlCl::OnPaint()
{
	...
	{ 
		...
		//CDFontEx::DrawText(this,&dc,  12, 400, m_HChar[i], tRect, dc.GetTextColor(), DT_END_ELLIPSIS | DT_LEFT | DT_TOP| DT_SINGLELINE);
...
void CListCtrlCl::DrawItem(LPDRAWITEMSTRUCT lpDrawItemStruct)
{
	...
	for ( int nCol=0; GetColumn(nCol, &lvc); nCol++)
	{
		...
		DrawText(lpDrawItemStruct->hDC, lpBuffer, int(mystrlen(lpBuffer)), 
			&rcItem, uFormat) ;
		//CDFontEx::DrawText(this,pDC,  12, 400, lpBuffer, rcItem, pDC->GetTextColor(), uFormat);
