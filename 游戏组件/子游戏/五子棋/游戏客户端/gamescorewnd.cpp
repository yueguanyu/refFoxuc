...
CGameScoreWnd::CGameScoreWnd() : CDialog(IDD_OPTION)
{
	...
	m_ImageBack.LoadFromResource(AfxGetInstanceHandle(),IDB_GAME_SCORE);
...
void CGameScoreWnd::OnPaint()
{
	...
	for (int i=0;i<GAME_PLAYER;i++)
	{
		...
		myprintf(szBuffer,sizeof(szBuffer),TEXT("%I64d"),m_GameScoreInfo.lScore[i]);
