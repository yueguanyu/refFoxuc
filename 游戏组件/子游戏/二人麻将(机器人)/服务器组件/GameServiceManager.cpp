...
//机器定义
#ifndef _DEBUG
#define ANDROID_SERVICE_DLL_NAME	TEXT("SparrowERAndroid.dll")	//组件名字
#else
#define ANDROID_SERVICE_DLL_NAME	TEXT("SparrowERAndroid.dll")	//组件名字
#endif
...
CGameServiceManager::CGameServiceManager()
{
	...
	lstrcpyn(m_GameServiceAttrib.szDataBaseName,TEXT("QPSparrowERDB"),CountArray(m_GameServiceAttrib.szDataBaseName));
	lstrcpyn(m_GameServiceAttrib.szClientEXEName,TEXT("SparrowER.EXE"),CountArray(m_GameServiceAttrib.szClientEXEName));
	lstrcpyn(m_GameServiceAttrib.szServerDLLName,TEXT("SparrowERServer.DLL"),CountArray(m_GameServiceAttrib.szServerDLLName));
...
bool CGameServiceManager::RectifyParameter(tagGameServiceOption & GameServiceOption)
{
	...
	{
		GameServiceOption.lMinTableScore=__max(GameServiceOption.lCellScore*11,GameServiceOption.lMinTableScore);
	}
