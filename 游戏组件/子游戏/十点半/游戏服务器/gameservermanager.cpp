...
CGameServiceManager::CGameServiceManager(void)
{
	...
	lstrcpyn(m_GameServiceAttrib.szClientEXEName,TEXT("TenHalfPoint.EXE"),CountArray(m_GameServiceAttrib.szClientEXEName));
	lstrcpyn(m_GameServiceAttrib.szServerDLLName,TEXT("TenHalfPointServer.DLL"),CountArray(m_GameServiceAttrib.szServerDLLName));
...
bool CGameServiceManager::RectifyParameter(tagGameServiceOption & GameServiceOption)
{
	...
	//积分下限
	GameServiceOption.lMinTableScore=__max(GameServiceOption.lCellScore*240L,GameServiceOption.lMinTableScore);
