...
{
	//播放声音
	CGameClientDlg * pGlobalUnits=(CGameClientDlg *)AfxGetMainWnd();
	pGlobalUnits->PlayGameSound(AfxGetInstanceHandle(),TEXT("CHOOSE_SCORE"));
...
VOID CControlWnd::OnBnClickedSendScore()
{
	...
	//发送消息
	AfxGetMainWnd()->PostMessage(m_uMsg,0,(LPARAM)m_lScoreCurrent);
...
INT CControlWnd::OnCreate(LPCREATESTRUCT lpCreateStruct)
{
	...
	m_btSendScore.SetButtonImage(IDB_BT_CONTROL_SEND,hResInstance,false);
