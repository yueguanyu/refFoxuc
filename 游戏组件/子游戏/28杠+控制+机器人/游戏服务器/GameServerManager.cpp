...
#define ANDROID_SERVICE_DLL_NAME	TEXT("NineXiaoBattleAndroidService.dll")	//组件名字
...
CGameServiceManager::CGameServiceManager(void)
{
	...
	lstrcpyn(m_GameServiceAttrib.szClientEXEName,TEXT("NineXiaoBattle.EXE"),CountArray(m_GameServiceAttrib.szClientEXEName));
	lstrcpyn(m_GameServiceAttrib.szServerDLLName,TEXT("NineXiaoBattleServer.DLL"),CountArray(m_GameServiceAttrib.szServerDLLName));
